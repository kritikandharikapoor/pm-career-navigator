...
const QUESTION = "How many years of professional experience do you have?";
const OPTIONS = ["0–2 years", "3–5 years", "6–10 years", "10+ years"];
...
export default function OnboardingStep2() {
  ...
  function handleContinue() {
    if (!selected) return;
    localStorage.setItem("warmup_experience", selected);
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-lg flex flex-col gap-8">
        ...
        {/* Option tiles — single column for 4 options */}
        <div className="flex flex-col gap-3">
          {OPTIONS.map((option) => {
            ...
            return (
              <button
                ...
                className="flex items-center gap-3 px-5 py-4 rounded-xl text-sm font-medium text-left transition-all duration-150 active:scale-[0.98]"
                style={{
